...
struct PsykologView: View {
    ...
    private func loadAISuggestion() async {
        ...
        let prompt = "Personen skriver: \"\(emotionContext)\" Ge ett kort, varmt och hoppfullt råd (2 meningar) på svenska om varför det är viktigt att söka professionell hjälp vid psykisk ohälsa. Börja med att validera känslan av att ta steget."
